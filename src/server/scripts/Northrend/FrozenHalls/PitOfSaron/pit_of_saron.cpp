...
const Position IceCiclespawnPointGlacialRevenant[1] =
{
    {1054.192993f, -92.951447f, 632.793213f, 4.186723f},
};
...
class npc_colapsing_icicle : public CreatureScript
{
   public:
       npc_colapsing_icicle() : CreatureScript("npc_colapsing_icicle") { }
       ...
       struct npc_colapsing_icicleAI : public ScriptedAI
       {
           npc_colapsing_icicleAI(Creature *c) : ScriptedAI(c)
           {
...
class mob_disturbed_glacial_revenant : public CreatureScript
{
    public:
        mob_disturbed_glacial_revenant() : CreatureScript("mob_disturbed_glacial_revenant") { }

        struct mob_disturbed_glacial_revenantAI: public ScriptedAI
        {
            mob_disturbed_glacial_revenantAI(Creature* creature) : ScriptedAI(creature)
            {
            }
        ...
        CreatureAI* GetAI(Creature* creature) const
        {
            return new mob_disturbed_glacial_revenantAI(creature);
        }
};
    ...
    public:
        ...
        {    
            ...
            if (instance->GetData(DATA_AREA_TRIGGER_FALLEN) == DONE && instance->GetData(DATA_AREA_TRIGGER_YMIRJAR) == DONE)  
            {
                ...
                for (uint8 i = 0; i < 1; i++)
                {
                   player->SummonCreature(NPC_GLACIAL_REVENANT, IceCiclespawnPointGlacialRevenant[i], TEMPSUMMON_DEAD_DESPAWN, 0);
                }
                return false;
            }
              return false;   
...
void AddSC_pit_of_saron()
{
    ...
    new mob_disturbed_glacial_revenant();
    new npc_colapsing_icicle();
